...
export const createCollection = async (
  req: AuthenticatedRequest<{ id: string }, any, Partial<CreateCollectionBody>>,
  res: Response
): Promise<void> => {
  try {
...
export const getCollectionsFiltered = async (
  req: Request<{}, {}, FilterCollectionsBody>,
  res: Response
): Promise<void> => {
  try {
...
export const getCollections = async (
  req: Request<{}, {}, {}, GetCollectionsQuery>,
  res: Response
): Promise<void> => {
  try {
